...
function ProductManagement() {
  ...
  const moduleName = 'product management';
  ...
  useEffect(() => {
    ...
    if (prevActiveTab !== null) {
      ...
      updateParams('PROGRAM_MANAGEMENT');
    }
  }, []);
  ...
  const fetchOrgList = async (dropdownFilters?: Array<any>) => {
    ...
    console.log(
      Object.keys(filterTableObj).length,
      'Object.keys(filterTableObj).length'
    );
        ...
        <Box>
          ...
          <Box className="search-container">
            ...
            <Box>
              ...
              >
                {buttonData.map((item: any, index: any) => {
                  return (
                    // index
            ...
            <Table aria-label="customized table">
              ...
              >
                {tableHeaderData.map((items: any, index: any) => {
                  return (
                    <TableRow key={index} className="authTableHeader">
